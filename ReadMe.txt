========================================================================
    ACTIVE TEMPLATE LIBRARY : StatusBarExt Project Overview
========================================================================

AppWizard has created this StatusBarExt project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

StatusBarExt.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

StatusBarExt.vcxproj.filters
...
StatusBarExt.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (StatusBarExt.h)
        GUID definitions                                (StatusBarExt_i.c)
        A type library                                  (StatusBarExt.tlb)
        Marshaling code                                 (StatusBarExt_p.c and dlldata.c)

StatusBarExt.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in StatusBarExt.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named StatusBarExt.pch and a precompiled types file named StdAfx.obj.
...
StatusBarExtps.vcxproj
	...
	dlldata.c, StatusBarExt_i.c and StatusBarExt_p.c which are required
	to build the proxy/stub DLL.

StatusBarExtps.vcxproj.filters
